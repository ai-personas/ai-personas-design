...
Personas inspect generic execution and tool capabilities, acquire or author a capability when needed, and create the artifacts they judge necessary. The runtime contains no task-word, profession-word, filename, extension, or domain-regex branch that causes CAD, CAM, a specialist birth, or a particular deliverable.
