...
| R-v1.0-8 | **Population-scale evolution unspecified.** v1.0 ships single-kernel emergence; multi-kernel dynamics not yet specified. | Medium | High | Single-kernel population dynamics + Persona Genesis now drafted in [`16_POPULATION_DYNAMICS.md`](16_POPULATION_DYNAMICS.md) (v1.1 draft; cross-doc risks R-POP-1…7); multi-kernel federated genesis remains a v1.1+ extension (OQ-POP-4); explicit non-goal in §2.2. | v1.1. |
