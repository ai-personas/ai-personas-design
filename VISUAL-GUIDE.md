...
![Distinct perspectives. Accountable outcomes. See the text reading immediately below.](assets/visuals/poster-01-blueprint.svg)
...
![From intent to an honest outcome. See the text reading immediately below.](assets/visuals/poster-02-end-to-end-flow.svg)
...
![A continuing identity. A situated perspective. See the text reading immediately below.](assets/visuals/poster-03-persona-anatomy.svg)
...
![Cooperation without a collective mind. See the text reading immediately below.](assets/visuals/poster-04-persona-society.svg)
...
![Embodiment is an accountable connection. See the text reading immediately below.](assets/visuals/poster-05-embodiment-requirements.svg)
...
![Close the loop between choice and consequence. See the text reading immediately below.](assets/visuals/diagram-01-embodiment-loop.svg)
...
![Three layers. One recurring event path. See the text reading immediately below.](assets/visuals/diagram-02-conceptual-architecture.svg)
...
![Work ends. Identity can continue. See the text reading immediately below.](assets/visuals/diagram-03-identity-lifecycle.svg)
...
![Creation is not membership. Membership is not work. See the text reading immediately below.](assets/visuals/diagram-04-onboarding.svg)
...
![Retaining a memory is only the beginning. See the text reading immediately below.](assets/visuals/diagram-05-learning-loop.svg)
...
![A claim is only as strong as its evidence chain. See the text reading immediately below.](assets/visuals/diagram-06-evidence-chain.svg)
...
![Make progress. Keep the return paths visible. See the text reading immediately below.](assets/visuals/diagram-07-complete-journey.svg)
