...
| 17 | [`17_ECONOMY.md`](17_ECONOMY.md) | *(v2.0 draft)* An economy the personas author for themselves — the substrate ships only the inviolable physics, generic primitives, and an emergence ladder; personas (with humans contributing ideas) discover what has value, may research tokenisation/crypto and create their own settlement layers, so humans, personas, and other conscious beings thrive. | 12 min |
