...
| `11_ACCEPTANCE_TESTS` | [PASS] | `A-GEN*` family (26 tests; grown from the original 17 by the ADR-0050 §4G–§4J additions and the ADR-0083 A-GEN25/A-GEN26) registered; reuses `A-RB*` for the replication-bound paths. |
