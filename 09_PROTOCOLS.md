...
without network access or learner access to assessor authority. Permission,
ownership and timestamp changes are denied globally because this deployment's
filesystem boundary cannot mediate them safely by path. Some pip/venv and build
steps fail as a result; diagnostics and the acquisition contract state this
limitation. Supported source/archive recipes must verify their actual installed
results. A native adapter is not considered isolated merely because it claims
to support native command tools.
...
See `registry/SCHEMAS.md` (generated by `tools/registry.py render --write`; 1320 rows; registry sha256 d866cc7ee63948fcbc27125645ae9d51c1a71d3c38f2b05807b9efcbbf6fe684).
