...
The invariants are the protected foundation. These chapters and the implementation contracts define the detailed behavior. The requirement index points to them; acceptance scenarios test them. The overview, examples, diagrams, and source briefs explain them rather than override them.
